...
/* J Block is J
              JJJ
this is pos = 0
startx and starty is the coordinates for bottom left J -> this is important when making the display!!!!
...
class J: public Block{
    ...
    public:
    int levelcreation;
    J(int level, int startx, int starty, int pos = 0, char letter = 'J'); 
